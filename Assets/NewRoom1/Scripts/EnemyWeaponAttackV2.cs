...
public class EnemyWeaponAttackV2 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // Only attack when EnemyBehavior has confirmed line of sight (Chase state)
        if (enemyBehavior != null && enemyBehavior.CurrentState != EnemyBehavior.State.Chase) return;
